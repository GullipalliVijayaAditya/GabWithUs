package com.example.android.gabwithus.holders;
...
import com.example.android.gabwithus.activities.FullScreenActivity;
...
public class MessageHolder extends RecyclerView.ViewHolder {
    ...
    public void setRightMessage(String userid, final String message, long time, String type) {
        ...
        if (type.equals("text")) {
            ...
            Picasso.with(context).load(message).fit().networkPolicy(NetworkPolicy.OFFLINE).into(messageTextPictureRight, new Callback() {
                @Override
                ...
                @Override
                public void onError() {
                    Picasso.with(context).load(message).fit().into(messageTextPictureRight, new Callback() {
                        @Override
                        public void onSuccess() {
                            messageLoadingRight.setVisibility(View.GONE);
                        }
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                try {
                    ...
                    if (!image.equals("default")) {
                        Picasso.with(context).load(image).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics())).centerCrop().networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.user).into(messageImageRight, new Callback() {
                            @Override
                            public void onSuccess() {
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(context).load(image).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics())).centerCrop().placeholder(R.drawable.user).error(R.drawable.user).into(messageImageRight);
                            }
                        });
                    } else {
    ...
    public void setLeftMessage(String userid, final String message, long time, String type) {
        ...
        if (type.equals("text")) {
            ...
            Picasso.with(context).load(message).fit().networkPolicy(NetworkPolicy.OFFLINE).into(messageTextPictureLeft, new Callback() {
                @Override
                public void onSuccess() {
                    messageLoadingLeft.setVisibility(View.GONE);
                }
                ...
                @Override
                public void onError() {
                    Picasso.with(context).load(message).fit().into(messageTextPictureLeft, new Callback() {
                        @Override
                        public void onSuccess() {
                            messageLoadingLeft.setVisibility(View.GONE);
                        }
        ...
        userListener = new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                try {
                    ...
                    if (!image.equals("default")) {
                        Picasso.with(context).load(image).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics())).centerCrop().networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.user).into(messageImageLeft, new Callback() {
                            @Override
                            public void onSuccess() {
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(context).load(image).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics())).centerCrop().placeholder(R.drawable.user).error(R.drawable.user).into(messageImageLeft);
                            }
                        });
                    } else {
