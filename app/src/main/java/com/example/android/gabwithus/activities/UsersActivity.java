...
import com.example.android.gabwithus.holders.UserHolder;
import com.example.android.gabwithus.models.User;
            ...
            protected void onBindViewHolder(final UserHolder holder, int position, User model) {
                ...
                holder.getView().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent userProfileIntent = new Intent(UsersActivity.this, com.example.android.gabwithus.activities.ProfileActivity.class);
