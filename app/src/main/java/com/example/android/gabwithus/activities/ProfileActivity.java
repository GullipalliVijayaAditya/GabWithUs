package com.example.android.gabwithus.activities;
...
public class ProfileActivity extends AppCompatActivity {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    ...
                    if (!layoutImage.equals("default")) {
                        Picasso.with(getApplicationContext()).load(layoutImage).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 180, getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 180, getResources().getDisplayMetrics())).centerCrop().networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.user).error(R.drawable.user).into(image, new Callback() {
                            @Override
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(getApplicationContext()).load(layoutImage).resize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 180, getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 180, getResources().getDisplayMetrics())).centerCrop().placeholder(R.drawable.user).error(R.drawable.user).into(image);
                            }
                        });
                        ...
                        image.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(ProfileActivity.this, com.example.android.gabwithus.activities.FullScreenActivity.class);
                    ...
                    if (!layoutCover.equals("default")) {
                        Picasso.with(getApplicationContext()).load(layoutCover).resize(getResources().getDisplayMetrics().widthPixels, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 260, getResources().getDisplayMetrics())).centerCrop().networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.logo_cover).error(R.drawable.logo_cover).into(cover, new Callback() {
                            @Override
                            public void onSuccess() {
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(getApplicationContext()).load(layoutCover).resize(getResources().getDisplayMetrics().widthPixels, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 260, getResources().getDisplayMetrics())).centerCrop().placeholder(R.drawable.logo_cover).error(R.drawable.logo_cover).into(cover);
                            }
                        });
                    } else {
    ...
    public void setFabMenu(int index) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent chatIntent = new Intent(ProfileActivity.this, com.example.android.gabwithus.activities.ChatActivity.class);
