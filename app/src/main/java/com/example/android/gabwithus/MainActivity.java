...
import com.example.android.gabwithus.activities.ProfileActivity;
import com.example.android.gabwithus.activities.UsersActivity;
import com.example.android.gabwithus.activities.WelcomeActivity;
import com.example.android.gabwithus.fragments.ChatFragment;
import com.example.android.gabwithus.fragments.FriendsFragment;
import com.example.android.gabwithus.fragments.RequestsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(getSupportFragmentManager(), FragmentPagerItems.with(this).add("Requests", RequestsFragment.class).add("Chat", ChatFragment.class).add("Friends", FriendsFragment.class).create());
