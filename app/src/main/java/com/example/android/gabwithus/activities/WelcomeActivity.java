...
import com.example.android.gabwithus.MainActivity;
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            if (FirebaseAuth.getInstance().getCurrentUser().isEmailVerified()) {
                                                ...
                                                new Handler().postDelayed(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        CircularAnim.fullActivity(WelcomeActivity.this, loginButton).colorOrImageRes(R.color.colorGreen).go(new CircularAnim.OnAnimationEndListener() {
                                                            @Override
